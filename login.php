			...
			<div class="container">	
				<form id="loginForm" name="loginForm" method="post" action="checkLogin.php">
					<div class="row">
						...
						<div class="col-md-6 errClass" id="com_err"></div>
					</div>
					<div class="row">
						<div class="col-md-3"></div>
						<div class="col-md-6">
					...
					<div class="row">
						<div class="col-md-3"></div>
						<div id="email_id_err" class="col-md-3 errClass"></div>	
					</div>
					...
					<div class="row">
						...
						<div class="col-md-6">
							...
							<input type="password" id="pwrd" name="pwrd" class="form-control" placeholder="Your Password">
						</div>
					</div>
					<div class="row">
						<div class="col-md-3"></div>
						<div id="pwrd_err" class="col-md-3 errClass"></div>	
					</div>
					<div class="row">
						<div class="col-md-3"></div>
						<div class="col-md-2"><a href="forgetpassword.php">Forgot password</a></div>
						<div class="col-md-3"></div>
						<div class="col-md-2"><a href="register.php">Sign Up</a></div>
					</div>
					<div class="row" style="height:30px;"></div>
					<div class="row">
						<div class="col-md-5"></div>
						<div class="col-md-3">
							<input type="button" value="Submit" class="btn btn-primary" onclick="javascript:validateLogin();">
	...
	<script type="text/javascript">
		...
		function validateLogin(){
			...
			if(email_id.trim()==''){	
				$('#email_id').focus();
				$('#email_id_err').show();
				$('#email_id_err').text('Please enter your email id');
			}else if(!isValidEmail(email_id)){
				$('#email_id').focus();
				$('#email_id_err').show();
				$('#email_id_err').text('Please enter valid email id');
			}else if(pwrd.trim()==''){
				$('#pwrd').focus();
				$('#pwrd_err').show();
				$('#pwrd_err').text('Please enter your password');
			}else{
				$.ajax({  
					url:"checkLogin.php",  
					type:"json",
					method:"POST",  
					data:{'email_id':email_id,'password':pwrd},  
