  ...
  <!-- Facebook and Twitter integration -->
	...
	<div id="page">
		...
		<div id="colorlib-rooms" class="colorlib-light-grey" >
			...
			<div class="container">	
				<form id="signupForm" name="signupForm" method="post" action="saveUser.php" enctype="multipart/form-data">
					...
					<div class="row form-group">
						<div class="col-md-6 errClass" id="fname_err"></div>
						<div class="col-md-6 errClass" id="lname_err"></div>
					</div>
					...
					<div class="row form-group">
						<div class="col-md-12 errClass" id="email_err"></div>
					</div>	
					
					<div class="row form-group">
						<div class="col-md-12">
							<label for="contact_no">Contact no</label>
							<input type="text" id="contact_no" name="contact_no" class="form-control" maxlength="10" placeholder="Your mobile no" />
						</div>
					</div>
					
					<div class="row form-group">
						<div class="col-md-12 errClass" id="contact_no_err"></div>
					</div>
					...
					<div class="row form-group">
						<div class="col-md-12 errClass" id="fileupload_err"></div>
					</div>
					
					<div class="row">
						<div class="col-md-5"></div>
						<div class="col-md-3">
							<input type="button" value="Submit" class="btn btn-primary" onclick="javascript:validateUser();">
	...
	<script type="text/javascript">
		function isValidEmail(str) {
			emailRe = /^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*\.(\w{2}|(co.in|com|net|org|edu|int|mil|gov|arpa|biz|aero|name|coop|info|pro|museum))$/
			if (!emailRe.test(str))	
				return false	
			else
				return true				
		...
		function validateUser(){
			...
			if(fname.trim()==''){	
				$('#fname').focus();
				$('#fname_err').show();
				$('#fname_err').text('Please enter your first name');
			}else if(lname.trim()==''){	
				$('#lname').focus();
				$('#lname_err').show();
				$('#lname_err').text('Please enter your last name');
			}else if(email.trim()==''){	
				$('#email').focus();
				$('#email_err').show();
				...
				$('#contact_no').focus();
				$('#contact_no_err').show();
				$('#contact_no_err').text('Please enter valid contact no');
			}else{
